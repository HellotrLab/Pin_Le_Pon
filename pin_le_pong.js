...
function setup() {
  ...
  noLoop();
  describe(
    'Two narrow rgb(160,16,16) rectangles and a rgb(56,9,174) square representing the paddles and ball in a game of ping pong. The player scores are displayed in the upper corners, and initially text reads "Click to start"'
  );
}
...
function draw() {
  ...
  // Draw the paddle with blue color
  ...
  if (isLooping() === false) {
    text('Cliquez Pour', width / 2, height / 2 - 40);
    text('Commencer', width / 2, height / 2 - 0);
